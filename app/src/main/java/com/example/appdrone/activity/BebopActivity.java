...
import com.example.appdrone.view.H264VideoView;
...
public class BebopActivity extends AppCompatActivity {
    ...
    private final BebopDrone.Listener mBebopListener = new BebopDrone.Listener() {
        ...
        public void onBatteryChargeChanged(int batteryPercentage) {
            ...
            {
                mBatteryImage.setImageResource(R.drawable.b10);
            }
           else if(batteryPercentage>15 &&batteryPercentage < 25)
            {
                mBatteryImage.setImageResource(R.drawable.b15);
            }
            else if( batteryPercentage>= 25 && batteryPercentage < 50)
            {
                mBatteryImage.setImageResource(R.drawable.b25);
            }
            else if( batteryPercentage>= 50 && batteryPercentage < 75)
            {
                mBatteryImage.setImageResource(R.drawable.b50);
            }
            else if( batteryPercentage>= 75 && batteryPercentage < 95)
            {
                mBatteryImage.setImageResource(R.drawable.b75);
            }
            else
            {
                mBatteryImage.setImageResource(R.drawable.b100);
            }
        }
