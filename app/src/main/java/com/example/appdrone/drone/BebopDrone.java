package com.example.appdrone.drone;
...
public class BebopDrone {
     ...
     * metodo agregado
     */
    public void setFollow( byte h,byte v)
    {
    ...
    {
        Log.i(TAG,"Mover el dron a una coordenada Flip");
        //mDeviceController.getFeatureARDrone3().sendPilotingMoveTo(50,50,5,ARCOMMANDS_ARDRONE3_PILOTING_MOVETO_ORIENTATION_MODE_ENUM.ARCOMMANDS_ARDRONE3_PILOTING_MOVETO_ORIENTATION_MODE_NONE,10);
        mDeviceController.getFeatureARDrone3().sendPilotingMoveBy(0,0,1,0);
        takePicture();
        mDeviceController.getFeatureARDrone3().sendPilotingMoveBy(0,1,0,0);
        takePicture();
        mDeviceController.getFeatureARDrone3().sendPilotingMoveBy(1,0,0,0);
        mDeviceController.getFeatureARDrone3().sendPilotingMoveBy(0,-1,0,0);
        mDeviceController.getFeatureARDrone3().sendPilotingMoveBy(-1,0,0,0);
        mDeviceController.getFeatureARDrone3().sendPilotingMoveBy(0,1,0,0);
        getLastFlightMedias();
